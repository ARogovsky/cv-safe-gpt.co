 ...
 *   Production: npx tsx scripts/check-console-errors.ts https://esupport.org.ua
 *
...
function getUrls(): string[] {
  ...
  urls.push('https://esupport.org.ua/privacidad', 'https://esupport.org.ua/privacy')

  // Convert to use the base URL
  return urls.map(url => url.replace('https://esupport.org.ua', baseUrl))
}

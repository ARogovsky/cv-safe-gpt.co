...
export const n8nContent = {
  es: {
    ...
    seo: {
      title: 'n8n para PMs: Cheat Sheet + Templates IA Gratis | esupport.org.ua',
  ...
  en: {
    ...
    seo: {
      title: 'n8n for PMs: Cheat Sheet + Free AI Templates | esupport.org.ua',
